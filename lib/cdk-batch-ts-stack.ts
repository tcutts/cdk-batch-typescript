...
export class CdkBatchTsStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const compute_environment = new batch.ManagedEc2EcsComputeEnvironment(this, "ComputeEnvironment", {
      vpc, useOptimalInstanceClasses: true,
      instanceClasses: [ec2.InstanceClass.C6A]
    })
    ...
    const bucket_arrival_function = new lambda.Function(this, "BucketArrival", {
      runtime: lambda.Runtime.PYTHON_3_12,
      code: lambda.Code.fromAsset("lambda/bucket_arrival"),
    ...
    input_bucket.addObjectCreatedNotification(new s3n.LambdaDestination(bucket_arrival_function))
    ...
    if (email.valueAsString === "") {
      ...
      new sns.Subscription(this, "NotifyMe", {
        topic, protocol: sns.SubscriptionProtocol.EMAIL,
    ...
    new cdk.CfnOutput(this, "InputBucketName", { value: input_bucket.bucketName })
    new cdk.CfnOutput(this, "OutputBucketName", { value: output_bucket.bucketName })
